...
export class Menu extends React.Component {
  ...
  render() {
    const { title, align, barStyle } = this.props;

    return (
      <Wrapper>
        <MenuButton className="hamburger-menu" onClick={this.openMenu}>
          <MenuTitle>{title || 'Menu'}</MenuTitle>
        ...
        {this.props.mobileButton ? this.props.mobileButton : (
          <HamburgerButton onClick={this.openMenu}>
            <HamburgerBar barStyle={barStyle} />
            <HamburgerBar barStyle={barStyle} />
            <HamburgerBar barStyle={barStyle} />
          </HamburgerButton>
        )}
        <MenuBackground isOpen={this.state.isOpen} onClick={this.closeMenu} />
        <MenuContent isOpen={this.state.isOpen} onClick={this.closeMenu} align={align}>
          {this.props.children}
        </MenuContent>
      </Wrapper>
    );
